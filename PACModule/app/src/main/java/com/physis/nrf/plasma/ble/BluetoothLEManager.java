package com.physis.nrf.plasma.ble;
...
import com.physis.nrf.plasma.ble.data.Beacon;
...
public class BluetoothLEManager {
    ...
    private void bleScanResult(BluetoothDevice bluetoothDevice, int rssi, byte[] scanRecord){
        if(bluetoothDevice != null && scanRecord != null){
            ...
            if(ibeacon !=null) {
                Log.e(TAG, "# Beacon : " + bluetoothDevice.getName() + "-" + bluetoothDevice.getAddress());
                ...
                bleHandler.obtainMessage(BLE_SCAN_DEVICE, new BLEDevice(bluetoothDevice, rssi)).sendToTarget();
            }
        }
    }
    ...
    public void writeCharacteristic(String writeData){
        boolean result = bluetoothLEService.writeCharacteristic(writeData);
